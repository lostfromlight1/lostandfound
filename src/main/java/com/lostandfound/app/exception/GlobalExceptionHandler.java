...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BaseErrorResponse> handleAuth(HttpServletRequest request) {
        return buildAndLogResponse(ErrorCode.AUTH_FAILED, request, "Invalid email or password", null);
    }

    @ExceptionHandler(AccessDeniedException.class)
    public ResponseEntity<BaseErrorResponse> handleAccessDenied(HttpServletRequest request) {
    ...
    public ResponseEntity<BaseErrorResponse> handleJsonError(HttpServletRequest request) {
        return buildAndLogResponse(
    ...
    private ResponseEntity<BaseErrorResponse> buildAndLogResponse(
        ...
        return buildResponse(code, request.getRequestURI(), message, validationErrors);
    }

    private ResponseEntity<BaseErrorResponse> buildResponse(
            ErrorCode code, String path, String message, Map<String, String> validationErrors) {
